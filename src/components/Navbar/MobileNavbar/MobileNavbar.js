        ...
        <div className={` z-50 menu-container flex sm:hidden h-screen top-0 fixed bg-fixed w-[60vw] bg-gray-200 transition-transform transform ${isOpen ? "" : "translate-x-[-100%]"} duration-300`}>
            <div className="flex flex-col">
                ...
                <ul className="flex gap-8 flex-col m-5">
                    ...
                    <li onClick={()=> scrollToSection('about')}><i class="fa-regular fa-user"></i> About</li>
                    <li onClick={()=> scrollToSection('projects')}><i class="fa-solid fa-diagram-project"></i> Projects</li>
                    <li onClick={()=> scrollToSection('contact')}><i class="fa-solid fa-address-book"></i> Contact</li>
                </ul>
            </div>
        </div>
        </>
